...
licks = [[(1, 0.5*1.3), (1, 0.5*0.7), (1, 0.5*1.3), (1, 0.5*0.7)],[(-1, 0.5), (-1, 0.5), (-1, 0.5), (-1, 0.5)]]
licks.append([(1, 0.5 * 1.1), (1, 0.5 * 0.9), (1, 0.5 * 1.1), (1, 0.5 * 0.9)])
licks.append([(1, 0.5*1.5),(-1,0.5*0.5),(1,0.5*1.1),(-1,0.5*0.9)])
